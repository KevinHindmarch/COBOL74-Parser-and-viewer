...
class Node:
    ...
    def __init__(self, node_type):
        self.type = node_type
        self.position = None  # Line and column position in source
...
class CobolParser:
    ...
    def _parse_section(self, line):
        ...
        self.current_section = Section(section_name)
    ...
    def _parse_paragraph(self, line):
        ...
        self.current_paragraph = Paragraph(paragraph_name)
        ...
        if self.current_section:
            ...
            if "PARAGRAPHS" not in self.current_division.sections:
                self.current_division.sections["PARAGRAPHS"] = Section("PARAGRAPHS")
...
class CobolAstGenerator:
    ...
    def to_json(self, ast):
        """Convert AST to JSON"""
        return json.dumps(ast, default=lambda o: o.__dict__, indent=2)
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: python cobol_parser.py <file_or_pattern>")
        sys.exit(1)
